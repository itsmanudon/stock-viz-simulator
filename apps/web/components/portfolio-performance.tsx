    ...
    <section aria-labelledby="portfolio-heading" className="border-b border-border-muted pb-6">
      ...
      <div className="mt-7 grid gap-5 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-end">
        <div className="min-w-0">
          <p className="font-mono text-4xl font-semibold tracking-[-0.04em] sm:text-5xl" data-financial>
        ...
        <div className="lg:text-right">
          ...
          {latestDate ? (
            <p className="mt-1 text-xs text-muted-foreground">Snapshot through {formatDate(latestDate)}</p>
          ) : null}
        </div>
      </div>
