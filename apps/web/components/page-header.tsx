...
export function PageSubnav({
  ...
  return (
    <nav aria-label={label} className="mt-4 border-b border-border-muted">
          ...
          return (
            <li key={item.href}>
              <a
                ...
                className={cn(
                  "inline-flex h-9 items-center border-b-2 px-2.5 text-sm whitespace-nowrap transition-colors",
                  active
