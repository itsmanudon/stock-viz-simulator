...
- [x] **Step 1: Write the failing route-mapping tests**
...
- [x] **Step 1: Write failing tests for blank input, results, keyboard selection, stale requests, errors, and the shortcut**
...
describe("GlobalTickerSearch", () => {
  ...
  it("keeps the newest response when requests resolve out of order", async () => {
    ...
    const first = new Promise<Symbol[]>((resolve) => {
...
- [x] **Step 3: Implement the accessible debounced combobox**
...
- [x] **Step 5: Run the existing symbol API tests**
...
- [x] **Step 6: Commit the search behavior**
...
- [x] **Step 1: Write failing navigation-renderer and drawer tests**
...
- [x] **Step 3: Implement `AppNavigation` with active states and icons**
...
- [x] **Step 4: Implement desktop and mobile wrappers**
...
- [x] **Step 6: Commit responsive product navigation**
...
- [x] **Step 1: Add a failing shell-composition test**
...
- [x] **Step 3: Implement the utility bar and shell**
...
- [x] **Step 5: Commit shell composition**
...
- [x] **Step 1: Write a failing real-layout test at the intended route-group imports**
...
- [x] **Step 2: Run the topology test and verify RED**
...
- [x] **Step 3: Move route directories without changing URL-visible names**
...
- [x] **Step 4: Reduce the root layout to document concerns**
...
- [x] **Step 5: Add the product layout**
...
- [x] **Step 6: Add the public layout and update relocated action imports**
...
- [x] **Step 7: Run topology, typecheck, and unit tests**
...
- [x] **Step 8: Commit the route split**
...
- [x] **Step 1: Replace the minimal token set with the approved semantic palette**
...
- [x] **Step 2: Add the page-width primitive**
...
- [x] **Step 3: Verify the configuration through the real shell, lint, and typecheck**
...
- [x] **Step 4: Commit design foundations**
...
- [x] **Step 1: Add failing public-shell and workspace-home tests**
...
- [x] **Step 3: Implement the reduced public header**
...
- [x] **Step 4: Implement the lightweight dashboard**
...
- [x] **Step 5: Replace `SiteHeader` in the public layout and remove it**
...
- [x] **Step 6: Run focused tests and full web checks**
...
- [x] **Step 7: Commit public/product entry points**
...
- [x] **Step 1: Write the e2e shell tests before any integration fixes**
...
- [x] **Step 2: Run unit, lint, and typecheck gates first**
...
- [x] **Step 3: Run repository-wide backend regression gates**
...
- [x] **Step 5: Run Playwright when prerequisites are available**
...
- [x] **Step 6: Perform visual QA when a browser connection is available**
...
Execution note (2026-08-27): the three shell-specific Playwright scenarios passed against isolated StockViz web/API ports (`3017`/`8017`). The full suite could not be treated as a valid pass in the available local environment: port `3000` was occupied by an unrelated application, the configured service on `8000` was not StockViz, the local StockViz database lacked the `symbol_metrics` migration, and the published development `INTERNAL_API_TOKEN` is correctly rejected in production mode. The browser connector exposed no browser runtime, so screenshot-based light/dark visual QA was unavailable.

- [x] **Step 7: Review the final diff against every completion criterion**
...
- [x] **Step 8: Commit integration coverage and plan completion**
...
- [x] **Step 9: Record final Git state for handoff**
